package org.PowahCOE.coe.client;
...
public class CableOrbRenderer implements BlockEntityRenderer<CableOrbTile> {
    private static final ResourceLocation ORB_TEXTURE =
            ResourceLocation.fromNamespaceAndPath("powah", "textures/model/tile/energy_charge.png");

    public static final ModelLayerLocation LAYER = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("powahcoe", "cable_orb"), "cable_orb");
    ...
    public void render(CableOrbTile te, float pt, PoseStack matrix, MultiBufferSource rtb,
        ...
        if (te.containRecipe()) {
            ...
            if (capacity > 0) {
                ...
                int alpha = (int) (38 + progress * 217); // 0.15→38, 1.0→255
